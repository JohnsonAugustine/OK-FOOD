                            ...
                            <div class="row justify-content-center py-20">
                                <div class="col-xl-10">
                                    ...
                                    {!! Form::model($restaurant, ['route' => ['admin.restaurant.update', $restaurant->id], 'method' => 'PUT', 'files' => true]) !!}
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-confirm-password">City <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                            {{ Form::text('city', null, array('class' => 'form-control', 'required' => '', 'maxlength' => '255')) }}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-currency">District <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                            {{ Form::text('district', null, array('class' => 'form-control', 'required' => '', 'maxlength' => '255')) }}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-website">Street <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
