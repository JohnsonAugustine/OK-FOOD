...
<head>
    ...
    <!-- Stylesheets -->
    <!-- Codebase framework -->
    <link rel="stylesheet" id="css-main" href="{{ asset("/assets/css/codebase.mins.css") }}">
...
<div id="page-container"
     class="sidebar-o sidebar-inverse side-scroll page-header-fixed page-header-modern main-content-boxed">

    @include('merchant.partials.sideoverlay')
