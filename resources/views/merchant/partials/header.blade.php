                    ...
                    <div class="content-header-section">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="page-header-options-dropdown">
                                <h6 class="dropdown-header">Fullscreen Mode</h6>
                                <input type="button" class="btn btn-sm btn-block btn-alt-secondary" value="Fullscreen Mode" onclick="toggleFullScreen()">
